;StackAndConquer NSIS installer script
...
Section
  ...
  ;Add all files from folder StackAndConquer into installer (skip .md files)
  File /r /x *.md ${APPNAME}\*.*
  ...
  !insertmacro MUI_STARTMENU_WRITE_BEGIN Application
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuFolder\${APPNAME}.lnk" "$INSTDIR\StackAndConquer.exe"
